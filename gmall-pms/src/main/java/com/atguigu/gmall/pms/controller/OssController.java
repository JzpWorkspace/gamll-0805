...
public class OssController {
    ...
    public Resp<Object> policy(){
        String accessId = "LTAI4FmAQDxYz6YAyCuzEebq"; // 请填写您的AccessKeyId。
        String accessKey = "F3BIKdFQnEVxKODhT3SyjjSaSdLZsA"; // 请填写您的AccessKeySecret。
        String endpoint = "oss-cn-beijing.aliyuncs.com"; // 请填写您的 endpoint。
        String bucket = "jzp-gmall"; // 请填写您的 bucketname 。
