...
public class SkuBoundsController {
    ...
    @GetMapping("{skuId}")
    public Resp<List<ItemSaleVo>> queryItemSalesVoBySkuId(@PathVariable("skuId")Long skuId){
        List<ItemSaleVo> itemSaleVos = this.skuBoundsService.queryItemSalesVoBySkuId(skuId);
